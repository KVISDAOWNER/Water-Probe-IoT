            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1", new Info
                    {
                        Version = "1",
                        Title = "waterprobing",
                        Description = "waterprobing (ASP.NET Core 2.0)",
                        Contact = new Contact()
                        {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1/openapi.json", "waterprobing");

                    //TODO: Or alternatively use the original Swagger contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "waterprobing Original");
                });
