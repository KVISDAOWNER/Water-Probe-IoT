...
namespace IO.Swagger.Controllers.Tests
{
    ...
    public class HelperFunctionsTests
    {
        ...
        public void TimeToString1()
        {
            ...
            // Assert
            Assert.IsTrue(result == "1996-03-27T10:31:54+01:00");
        }
        [TestMethod()]
        public void TimeToString2()
        {
            ...
            // Assert
            Assert.IsTrue(result == "1996-03-09T01:03:04+01:00");
        }
        [TestMethod()]
        public void TimeToString3()
        {
            ...
            // Assert
            Assert.IsTrue(result == "1996-12-09T11:13:04+01:00");
        }
        [TestMethod()]
        public void TimeToString4()
        {
            ...
            // Assert
            Assert.IsTrue(result == "1996-12-20T11:01:34+01:00");
        }
        [TestMethod()]
        public void TimeToString5()
        {
            ...
            // Assert
            Assert.IsTrue(result == "2020-12-20T11:01:34+01:00");
        }
        [TestMethod()]
        public void TimeToString6()
        {
            ...
            // Assert
            Assert.IsTrue(result == "9999-12-31T23:59:59+01:00");
        }
        [TestMethod()]
